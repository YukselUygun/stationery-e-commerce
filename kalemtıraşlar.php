...
<head>
    ...
    <link rel="stylesheet" href="kalemtıraş.css">
...
<body>
    ...
    <section id="header">
        <a href="../Sepet"><img style="width: 30%;" src="../Listele/kalemtıraşlar/a (5).png" class="logo" alt=""></a>
    ...
    ?>
     <?php foreach($datas as $data): ?>
            <div class="pro">
                <img src="../Listele/kalemtıraşlar/<?= $data['resim_url']?>" alt="">
                <div class="des">
                ...
                <a href="detaylar_kalemtıraş.php?id=<?=$data['id']?>" class="cart"><i class="fa-solid fa-cart-shopping "></i></a>
            </div>
            <?php endforeach; ?>
        </div>
    </section>
    ...
    <footer class="section-p1">
        <div class="col1">
            <div class="col">
                <img class="logo" src="../Listele/kalemtıraşlar/a (3).png">
                <h4>İletişim</h4>
