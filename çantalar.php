...
<head>
    ...
    <link rel="stylesheet" href="çanta.css">
...
<body>
   ...
   <section id="header">
        <a href="../Sepet"><img style="width: 30%;" src="../Listele/çantalar/a (5).png" class="logo" alt=""></a>
    ...
    ?>
     <?php foreach($datas as $data): ?>
            ...
            <div   class="pro">
                <img src="../Listele/çantalar/<?= $data['resim_url']?>" alt="">
                <div class="des">
                ...
                <a href="detaylar_çanta.php?id=<?=$data['id']?>" class="cart"><i class="fa-solid fa-cart-shopping "></i></a>
            </div>
            <?php endforeach; ?>
        </div>
    </section>
    ...
    <footer class="section-p1">
        <div class="col1">
            <div class="col">
                <img class="logo" src="../Listele/çantalar/a (3).png">
                <h4>İletişim</h4>
