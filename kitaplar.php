...
<body>
    ...
    <section id="product1" class="section-p1">
        <h2>Okuma,Sınava Hazırlık Kitapları</h2>
    ...
    ?>
     <?php foreach($datas as $data): ?>
            <div class="pro">
                <img src="../Listele/kitaplar/<?= $data['resim_url']?>" alt="">
                <div class="des">
                ...
                <a href="detaylar_kitap.php?id=<?=$data['id']?>" class="cart"><i class="fa-solid fa-cart-shopping "></i></a>
            </div>
            <?php endforeach; ?>
        </div>
    </section>
