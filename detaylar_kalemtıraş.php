...
<body>
    ...
    <section id="header">
        ...
        <div>
            ...
            <li><a class="active" href="Anasayfa.php">Anasayfa</a></li>
                ...
                <li><a class="active" href="kalemtıraşlar.php">Kalemtraşlar</a></li>
        ...
        <div id="mobile">
            ...
            <a href="../Sepet2.html"><i class="fa-solid fa-cart-shopping"></i></a>
    ...
    if(!isset($_GET['id']) || empty($_GET['id'])){
        header('Location:kalemtıraşlar.php');
        exit;
    }
    $table = 'kalemtıraşlar';
    ...
    <section id="prodetails" class="section-p1">
            <div class="sepetana">
                <div class="single-pro-image">
                    ...
                    <img src="../Listele/kalemtıraşlar/<?= $data['resim_url']?>" width="100%" id="MainImg" alt="batu.png">
            ...
            <a href="./sepetadd_kalemtraslar.php?id=<?=$data['id']?>" style="background-color: rgb(105, 218, 255); color: black;border-radius: 20px;padding: 10px;">Sipariş Ver</a>
            <br><br>
            <h4>Ürün Detayı</h4>
