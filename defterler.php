...
<head>
    ...
    <link rel="stylesheet" href="defter.css">
...
?>
        ...
        <?php foreach($datas as $data): ?>
            ...
            <div   class="pro">
                <img src="../Listele/defterler/<?= $data['resim_url']?>" alt="">
                <div class="des">
                ...
                <a href="detaylar_defter.php?id=<?=$data['id']?>" class="cart"><i class="fa-solid fa-cart-shopping "></i></a>
            </div>
            <?php endforeach; ?>
        </div>
    ...
    <footer class="section-p1">
        <div class="col1">
            <div class="col">
                <img class="logo" src="../Listele/defterler/a (3).png">
                <h4>İletişim</h4>
