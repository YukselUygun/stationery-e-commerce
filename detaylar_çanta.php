    ...
    <section id="header">
        ...
        <div>
            ...
            <li><a  href="Anasayfa.php">Anasayfa</a></li>
                ...
                <li><a class="active" href="çantalar.php">Çantalar</a></li>
    ...
    <section id="prodetails" class="section-p1">
            <div class="sepetana">
                <div class="single-pro-image">
                    ...
                    <img src="../Listele/çantalar/<?= $data['resim_url']?>" width="100%" id="MainImg" alt="batu.png">
            ...
            <a href="./sepetadd_cantalar.php?id=<?=$data['id']?>" style="background-color: rgb(105, 218, 255); color: black;border-radius: 20px;padding: 10px;">Sipariş Ver</a>
            <br><br>
            <h4>Ürün Detayı</h4>
